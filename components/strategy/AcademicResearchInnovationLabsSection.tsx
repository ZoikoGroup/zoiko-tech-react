...
export default function AcademicResearchInnovationLabsSection() {
        ...
        >
          ...
          >
            <div className="relative w-full max-w-[600px] aspect-[4/3] overflow-hidden rounded-[8px]">
              <img
                src="/strategy/7.png"
                alt="Researcher using VR headset to control robotic arm in modern innovation research lab"
          ...
          <motion.div variants={itemVariants} className="space-y-6 text-left">
            ...
            <p className="text-[#6B7280] text-sm sm:text-base font-normal leading-relaxed">
              Our partnerships with universities and AI ethics think tanks
              foster responsible R&amp;D, enriching our product roadmap with
              cutting-edge insight, particularly in eldercare, data ethics, and
