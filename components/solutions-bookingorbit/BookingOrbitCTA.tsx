...
export default function BookingOrbitCTA() {
  return (
    <section className="w-full bg-white py-16 px-4 md:px-8 min-h-[500px] flex items-center justify-center">
      <div className="max-w-6xl w-full mx-auto">
        ...
        >
          ...
          {/* Subtitle Paragraph */}
          <p className="text-[rgba(255,255,255,0.9)] font-inter font-normal text-[15px] sm:text-[16px] md:text-[18px] leading-[24px] sm:leading-[26px] md:leading-[28px] max-w-[680px] mb-8">
            Experience the future of travel with BookingOrbit. Plan, book, and
