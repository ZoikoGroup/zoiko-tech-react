...
const features: string[] = [
  "Usage-based, subscription, per-transaction, and performance-linked billing",
  "Support for multi-currency invoicing and FX calculations",
  "Dynamic tax compliance (VAT, GST, withholding, excise) across regions",
  "Merchant payout engines and fee-sharing models",
  "Financial dashboards for revenue analytics, audit prep, and compliance",
];

export default function ZoikoNexSection() {
  return (
      ...
      >
        ...
        >
          <div className="relative w-full h-full min-h-[380px] lg:min-h-[460px] rounded-sm overflow-hidden shadow-sm">
            <img
              src="/fintech/money.png"
              alt="ZoikoNex Financial Monetization Platform"
        ...
        <div className="lg:col-span-7 order-1 lg:order-2 space-y-6 flex flex-col justify-center py-2">
          <motion.div variants={itemVariants} className="space-y-4">
            <h2 className="text-2xl md:text-3xl font-bold tracking-tight text-[#1a1a1a] leading-tight">
              ZoikoNex™ – Monetization
              <br className="hidden md:block" /> Engine for Financial Products
            </h2>
            <p className="text-sm md:text-[15px] leading-relaxed text-[#666666]">
              ZoikoNex™ handles complex financial billing models — from SaaS
              pricing and interchange fees to tiered payroll structures and
              multi-party remittance charges.
            </p>
          </motion.div>
          ...
          >
            ZoikoNex™ ensures monetization is intelligent, transparent, and
            globally compliant.
          </motion.p>
        </div>
      </motion.div>
