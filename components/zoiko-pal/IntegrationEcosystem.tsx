...
const integrationItems = [
  {
    ...
    description:
      "Amazon Alexa Elder API, Google Nest Health, and Apple HomeKit for comprehensive home monitoring.",
  },
  {
    title: "Health Platform APIs",
    description:
      "Philips HealthSuite, GE Carestation Edge, and major EMR systems for professional healthcare integration.",
  },
  {
    title: "Wearable Device Support",
    description:
      "Apple HealthKit, Google Fit, Fitbit, and other major wearable platforms for continuous health tracking.",
  },
  {
    title: "Zoiko Ecosystem",
    description:
      "Full integration with Zoiko AI, Zoiko Axis, Zoiko Web Services, and Zoiko Assure for comprehensive governance.",
  },
];
      ...
      <div className="max-w-6xl mx-auto flex flex-col items-center">
        ...
        >
          ...
          <p className="text-[#64748b] text-[14.5px] sm:text-[15.5px] font-normal leading-relaxed">
            Seamlessly connects with leading health platforms and smart home
            devices
          </p>
        </motion.div>
