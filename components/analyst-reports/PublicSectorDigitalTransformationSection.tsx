...
export default function PublicSectorDigitalTransformationSection() {
        ...
        >
          ...
          >
            <div className="relative w-full max-w-[480px] h-auto overflow-hidden rounded-[5px]">
              <img
                src="/analyst-reports/3.png"
                alt="Team members discussing data analytics on screen in modern office environment"
          ...
          >
            <h3 className="text-2xl sm:text-3xl md:text-[2.25rem] font-bold text-[#111827] leading-tight">
              Public Sector Digital <br />
              Transformation
            </h3>

            <p className="text-[#6B7280] text-sm sm:text-base font-normal leading-relaxed max-w-xl">
              Assessment of how ZoikoSuite&trade;, Zoiko Web Services&trade;,
              and BookingOrbit&trade; are digitizing government payroll,
              benefits, procurement, and engagement portals &mdash; with special
              coverage on interoperability, accessibility, and compliance
              scalability.
            </p>
          </motion.div>
        </motion.div>
