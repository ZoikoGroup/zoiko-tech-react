...
const zoikoTimePlans = [
  {
    ...
    isRecommended: false,
    ctaText: "Get Started",
    ctaHref: "/signup?product=zoikotime&plan=starter",
    features: [
      "1 user",
      "Basic analytics",
      "Privacy by default",
  ...
  },
  {
    ...
    ctaHref: "/trial?product=zoikotime&plan=pro",
    features: [
      "Advanced insights",
      "All integrations",
      "30-day free trial",
...
export default function TransparentProductivityPricing() {
  return (
      ...
      <div className="max-w-6xl mx-auto flex flex-col items-center">
        ...
        >
          <h2 className="text-3xl sm:text-4xl md:text-[38px] font-bold text-[#1e293b] tracking-tight mb-4 leading-tight">
            Transparent Productivity Pricing
          </h2>
          <p className="text-[#64748b] text-[14.5px] sm:text-[15.5px] font-normal leading-relaxed">
            Ethical productivity insights for individuals, teams, and
            enterprises
          </p>
        </motion.div>
