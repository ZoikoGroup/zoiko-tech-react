...
export default function EmbeddedComplianceWhitePaperSection() {
        ...
        >
          ...
          >
            <h3 className="text-lg sm:text-xl font-bold text-[#374151] leading-snug max-w-xl">
              The Rise of Embedded <br />
              Compliance in Legal, Tax &amp; Public Workflows&ldquo;
            </h3>

            <p className="text-[#6B7280] text-sm sm:text-base font-normal leading-relaxed">
              A deep dive into how ZoikoAssure&trade; supports proactive,
              jurisdiction-aware <br /> regulation and audit readiness across
              multiple professional service environments.
            </p>
          </motion.div>
          ...
          >
            <div className="relative w-full max-w-[360px] sm:max-w-[400px] h-auto overflow-hidden">
              <img
                src="/white-papers/6.png"
                alt="Legal team conducting compliance meeting with scales of justice and wooden gavel on desk"
