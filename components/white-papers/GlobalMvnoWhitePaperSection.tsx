...
export default function GlobalMvnoWhitePaperSection() {
        ...
        >
          ...
          >
            <div className="relative w-full max-w-[360px] sm:max-w-[400px] h-auto overflow-hidden">
              <img
                src="/white-papers/7.png"
                alt="Engineer monitoring billing infrastructure and telecom network operations"
          ...
          >
            <h3 className="text-lg sm:text-xl font-bold text-[#374151] leading-snug max-w-xl">
              Global MVNO Enablement: <br />A Billing Infrastructure for the
              Converged Future
            </h3>

            <p className="text-[#6B7280] text-sm sm:text-base font-normal leading-relaxed max-w-xl">
              Unpacking how ZoikoNex&trade; enables seamless, real-time billing
              and compliance for telecoms operating across currencies, networks,
              and tax regimes.
            </p>
          </motion.div>
        </motion.div>
