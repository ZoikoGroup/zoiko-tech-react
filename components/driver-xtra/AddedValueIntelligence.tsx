...
const intelligenceCards = [
  {
    ...
    description:
      "Detects potential failures using connected vehicle data with AI analysis for proactive maintenance recommendations and cost savings.",
  },
  {
    title: "DriverXtra Rewards",
    description:
      "Comprehensive loyalty program for repeat purchases, insurance renewals, and eco-friendly choices with redeemable points and exclusive benefits.",
  },
  {
    title: "Cross-Platform Advertising",
    description:
      "Verified banner advertising for automotive ecosystem brands with performance tracking and targeted audience reach.",
  },
  {
    title: "ESG & Sustainability",
    description:
      "Carbon offset calculation per delivery integrated with Zoiko Assure reporting and environmental impact tracking for conscious consumers.",
  },
];

export default function AddedValueIntelligence() {
  return (
    <section className="w-full bg-white py-20 px-6 md:px-12 lg:px-16 overflow-hidden min-h-screen flex items-center">
      <div className="max-w-6xl mx-auto flex flex-col items-center w-full">
        ...
        >
          Beyond commerce - predictive insights and ecosystem benefits
        </motion.p>
