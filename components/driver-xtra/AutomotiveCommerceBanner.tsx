...
export default function AutomotiveCommerceBanner() {
  return (
    <section className="w-full bg-gradient-to-r from-[#4FD1C7] to-[#2C5F5D] py-20 px-6 md:px-12 lg:px-16 overflow-hidden flex items-center justify-center min-h-[480px]">
      <div className="max-w-4xl mx-auto flex flex-col items-center text-center">
        ...
        >
          DriverXtra — Global Automotive & Mobility Intelligence Marketplace
        </motion.p>
        ...
        >
          World&apos;s first global automotive and mobility intelligence
          marketplace integrating commerce, data, and connected ecosystem value
          with AI-powered fitment and comprehensive compliance
        </motion.p>
        ...
        >
          © 2025 Zoiko Group Inc. | Zoiko Orbit | All Rights Reserved | US
          English Edition
        </motion.p>
