...
const integrationItems = [
  {
    title: "Zoiko Platform Integration",
    description:
      "Native integration with Zoiko AI governance and agentic compliance, Zoiko Suite accounting and billing automation, and Zoiko Nex telecom-grade OSS/BSS.",
  },
  {
    title: "Zoiko Web Services",
    description:
      "Full implementation and lifecycle support including DevSecOps, infrastructure management, and compliance delivery with dedicated technical teams.",
  },
  {
    title: "Enterprise Systems",
    description:
      "Seamless integration with SAP, Oracle, Salesforce, Microsoft 365, and other enterprise platforms through secure APIs and data connectors.",
  },
  {
    title: "Security Framework",
    description:
      "Data stored in Tier-4 U.S. centers with cross-border transfers under Model Clauses and comprehensive encryption at rest and in transit.",
  },
];
      ...
      <div className="max-w-6xl mx-auto flex flex-col items-center">
        ...
        >
          ...
          <p className="text-[#64748b] text-[14.5px] sm:text-[15.5px] font-normal leading-relaxed">
            Comprehensive platform connectivity and API integration
          </p>
        </motion.div>
