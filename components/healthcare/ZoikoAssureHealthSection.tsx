...
const features: string[] = [
  "Regulatory mapping across HIPAA, GDPR, FDA, CE, MDR, ISO, and FSMA",
  "Embedded workflows for consent, labeling, storage, and export requirements",
  "Automated alerts for jurisdiction-specific health mandates",
  "Digital audit trails for regulatory inspections and documentation",
  "Cross-market policy governance for international product launches",
];

export default function ZoikoAssureHealthSection() {
  return (
      ...
      >
        ...
        <div className="lg:col-span-7 space-y-6 flex flex-col justify-center py-2">
          <motion.div variants={itemVariants} className="space-y-4">
            <h2 className="text-2xl md:text-3xl font-bold tracking-tight text-[#1a1a1a] leading-tight">
              ...
              <br className="hidden md:block" /> Intelligence for Global Health
              Operations
            </h2>
            <p className="text-sm md:text-[15px] leading-relaxed text-[#666666]">
              ZoikoAssure™ embeds compliance at every stage of the product and
              care lifecycle — from patient data handling to pharmaceutical
              distribution and nutraceutical claims management.
            </p>
          </motion.div>
          ...
          >
            ZoikoAssure™ helps you enter markets faster — and stay compliant
            longer.
          </motion.p>
        </div>
        ...
        >
          <div className="relative w-full h-full min-h-[380px] lg:min-h-[460px] rounded-sm overflow-hidden shadow-sm">
            <img
              src="/healthcare/doc.png"
              alt="ZoikoAssure Researcher in laboratory setting"
