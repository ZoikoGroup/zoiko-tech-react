...
export default function EnterpriseReliabilitySection() {
  ...
  const features = [
    "99.99% uptime SLAs supported by distributed cloud zones",
    "Anomaly detection and AI-based observability tools",
    "Live incident alerts with timestamps and scope breakdowns",
    "Maintenance notices, patch schedules, and changelog history",
    "End-to-end traceability across microservices and multi-tenant containers",
  ];
    ...
    <section className="w-full bg-white text-[#1D1D1F] py-24 px-6 sm:px-12 md:px-16 lg:px-24 font-sans antialiased overflow-hidden">
      <div className="max-w-6xl mx-auto w-full">
        ...
        >
          ...
          >
            <img
              src="/status-dashboard/3.png"
              alt="Built for Enterprise-Grade Reliability"
