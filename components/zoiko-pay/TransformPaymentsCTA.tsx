...
export default function TransformPaymentsCTA() {
  return (
    <section className="w-full bg-gradient-to-r from-[#44c3b8] via-[#379c93] to-[#2a756f] text-white px-6 md:px-12 lg:px-20 py-20 md:py-28 overflow-hidden">
      <div className="max-w-4xl mx-auto flex flex-col items-center text-center">
        ...
        >
          Join the next generation of intelligent payment processing with
          ZoikoPay
        </motion.p>
        ...
        >
          <Link
            ...
            className="w-full sm:w-auto min-w-[220px] text-center bg-white text-[#3ba8a0] font-semibold text-[15px] px-8 py-3.5 rounded-lg shadow-xs hover:bg-slate-50 transition-all duration-300"
          >
