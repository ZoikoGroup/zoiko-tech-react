  ...
  return (
    <section className="w-full bg-gradient-to-r from-[#44c3b8] via-[#379c93] to-[#2a756f] text-white px-6 md:px-12 lg:px-20 py-20 md:py-28 overflow-hidden">
      <div className="max-w-4xl mx-auto flex flex-col items-center text-center">
        ...
        >
          Join the next generation of AI-governed telecom and fintech
          convergence
        </motion.p>
        ...
        >
          ...
          <Link
            ...
            className="w-full sm:w-auto min-w-[200px] text-center bg-transparent border-2 border-white text-white font-semibold text-[15px] px-7 py-3.5 rounded-lg hover:bg-white/10 transition-all duration-300"
          >
            Explore Partnership
          </Link>
        </motion.div>
