...
const communityFeatures = [
  {
    title: "Local Events Directory",
    description:
      "Pet fairs, concerts, workshops, car shows, and community events with verified host badges and authentic reviews.",
  },
  {
    title: "Zoiko Social Integration",
    description:
      "Share events and experiences with friends, join discussion groups, and discover trending activities in your area.",
  },
  {
    title: "Ticketing & Donations",
    description:
      "Integrated ticketing system with charitable donation options powered by Zoiko Pay with full transparency.",
  },
  {
    title: "Community Safety",
    description:
      "Verified venue ratings, safety protocols, and community guidelines ensuring safe and positive experiences.",
  },
];

export default function CommunityAndEventsIntegration() {
  return (
      ...
      <div className="max-w-6xl mx-auto flex flex-col items-center">
        ...
        <div className="text-center mb-14 md:mb-16 max-w-3xl">
          ...
          <p className="text-[#64748b] text-[14.5px] sm:text-[15.5px] font-normal leading-relaxed">
            Connecting communities through verified events and social
            experiences
          </p>
        </div>
