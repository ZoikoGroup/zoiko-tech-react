...
const applications: string[] = [
  "Compliance with GDPR, HIPAA, local procurement laws, and transparency mandates",
  "Ethical oversight for grant distribution, field programs, and digital inclusion",
  "Risk scoring and program-level policy audits",
  "Jurisdictional frameworks for NGO registration and tax-exempt operation",
  "Localized governance policies for ministries, schools, and agencies",
];
      ...
      >
        ...
        <div className="w-full lg:w-[58%] order-1 space-y-6 flex flex-col justify-center py-2">
          <motion.div variants={itemVariants} className="space-y-4">
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold tracking-tight text-[#1a1a1a] leading-tight">
              ...
              <br className="hidden md:block" /> Compliance for NGOs &
              Governments
            </h2>
            <p className="text-sm md:text-[15px] leading-relaxed text-[#666666]">
              ZoikoAssure™ provides embedded compliance frameworks for regulated
              public work — including international development, education,
          ...
          >
            ZoikoAssure™ makes ethical and regulatory integrity operational —
            not optional.
          </motion.p>
        </div>
        ...
        >
          <div className="relative w-full h-full overflow-hidden rounded-sm">
            <img
              src="/social/tax.png"
              alt="Hands using laptop with digital tax and compliance icons"
