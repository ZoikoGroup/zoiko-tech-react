...
const features: string[] = [
  "Disbursement and milestone-based funding logic",
  "Donor reports, audit trails, and automated transparency dashboards",
  "Public-sector billing and vendor contract management",
  "Real-time spend tracking and performance scoring",
  "Integration with compliance reporting and oversight mechanisms",
];

export default function ZoikoNexFundingSection() {
  return (
      ...
      >
        ...
        >
          <div className="relative w-full h-full overflow-hidden rounded-sm">
            <img
              src="/social/nex.png"
              alt="Hand using stylus with growth graphics near laptop"
        ...
        <div className="w-full lg:w-[58%] order-1 lg:order-2 space-y-6 flex flex-col justify-center py-2">
          <motion.div variants={itemVariants} className="space-y-4">
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold tracking-tight text-[#1a1a1a] leading-tight">
              ZoikoNex™ – Transparent
              <br className="hidden md:block" /> Funding & Grant Management
            </h2>
            <p className="text-sm md:text-[15px] leading-relaxed text-[#666666]">
              ZoikoNex™ supports grant disbursement, donor engagement, public
              procurement, and accountability workflows — ensuring every dollar,
              euro, or pound is traceable and well-managed.
            </p>
          </motion.div>
          ...
          >
            From philanthropy to procurement — ZoikoNex™ brings visibility to
            mission finance
          </motion.p>
        </div>
      </motion.div>
