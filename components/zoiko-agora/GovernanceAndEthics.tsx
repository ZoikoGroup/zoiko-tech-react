...
const governanceCards = [
  {
    title: "Human-in-Command Council",
    description:
      "Dedicated oversight body for ZTI dispute appeals with transparent resolution processes and human oversight.",
  },
  {
    title: "AI Reasoning Transparency",
    description:
      "Complete AI reasoning logs available in Zoiko Assure Transparency Hub for full auditability and explainability.",
  },
  {
    title: "Data Security & Privacy",
    description:
      "All communications encrypted and auditable, compliant with cross-border data regulations and privacy laws.",
  },
  {
    title: "Ethics Monitoring",
    description:
      "Quarterly governance audits conducted via Zoiko AI's autonomous ethics monitoring layer for continuous improvement.",
  },
];
...
export default function GovernanceAndEthics() {
  return (
      ...
      <div className="max-w-6xl mx-auto flex flex-col items-center">
        ...
        >
          ...
          <p className="text-[#64748b] text-[14.5px] sm:text-[15.5px] font-normal leading-relaxed">
            Commitment to transparency, fairness, and responsible AI practices
          </p>
        </motion.div>

        {/* 4 Cards Grid (3 on top row, 1 on bottom row matching layout) */}
