...
export default function EsgSustainableInvestmentSection() {
  ...
  const points = [
    <>
      Environmental sustainability and conservation via GoLite Mobile and the
      Zoiko ESG Framework
    </>,
    <>Inclusive eldercare through AI-enabled tools like ZoikoPal&trade;</>,
    <>Secure digital transformation for underserved communities and NGOs</>,
    <>Public-sector modernization, transparency, and data sovereignty</>,
  ];
        ...
        >
          ...
          >
            <div className="relative w-full max-w-[480px] h-full min-h-[460px] sm:min-h-[520px] overflow-hidden rounded-[5px]">
              <img
                src="/investors/4.png"
                alt="Professional interacting with digital investment icons overlaid on screen"
          ...
          <div className="lg:col-span-7 space-y-6">
            <div className="space-y-4">
              ...
              >
                ZoikoTech&apos;s platforms are built to deliver long-term
                social, environmental, and economic resilience. Our impact areas
                include:
              </motion.p>
            </div>
            ...
            >
              We report annually on ESG alignment, climate impact, digital
              accessibility, and platform inclusion.
            </motion.p>
          </div>
        </motion.div>
      </div>
