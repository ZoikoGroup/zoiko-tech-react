...
const creatorCategories = [
  {
    ...
    items: [
      "Upload long & short-form content",
...
export default function ZoikoCreatorProgram() {
  return (
      ...
      <div className="max-w-6xl mx-auto flex flex-col items-center w-full">
        ...
        >
          ...
          <p className="text-[#666666] text-[15px] sm:text-[16px] leading-relaxed">
            Share your passion with a global audience.
          </p>
        </motion.div>
              ...
              <ul className="space-y-4 w-full text-left mt-auto">
                {category.items.map((item) => (
                  <li key={item} className="flex items-center gap-3">
                    <ArrowRight className="w-4 h-4 text-[#25A18E] shrink-0" />
