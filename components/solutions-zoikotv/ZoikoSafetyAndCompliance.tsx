...
const safetyCategories = [
  {
    ...
    items: ["GDPR/UK GDPR compliant", "CCPA compliant", "Data encryption"],
  },
  {
    title: "Content Governance",
    items: [
      "Animal safety rules",
      "Anti-misinformation policies",
      "Verified creator badges",
    ],
  },
  {
    title: "Moderation",
    items: ["AI-assisted moderation", "Human review team", "Appeals system"],
  },
];

export default function ZoikoSafetyAndCompliance() {
  return (
      ...
      <div className="max-w-6xl mx-auto flex flex-col items-center w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full items-stretch">
          {safetyCategories.map((category, index) => (
            ...
            >
              {/* Card Title */}
              <h3 className="text-xl md:text-[22px] font-bold text-[#1A202C] mb-8 leading-snug">
                {category.title}
              </h3>
