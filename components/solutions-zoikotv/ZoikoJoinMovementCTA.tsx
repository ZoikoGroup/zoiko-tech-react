      ...
      <div className="max-w-6xl mx-auto w-full">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 w-full sm:w-auto">
            {/* Primary Button */}
            <button onClick={()=>router.push("/zoiko-tv")} className="w-full cursor-pointer sm:w-auto min-w-[170px] px-7 py-3.5 bg-white text-[#006059] hover:bg-teal-50 font-semibold rounded-xl text-[15px] transition-all duration-200 shadow-md hover:shadow-lg active:scale-95">
              Explore ZoikoTV
            </button>

            {/* Secondary Outlined Button */}
            <button onClick={()=>router.push("/zoiko-social")} className="w-full cursor-pointer sm:w-auto min-w-[170px] px-7 py-3.5 bg-transparent border-2 border-white/80 text-white hover:bg-white/10 font-semibold rounded-xl text-[15px] transition-all duration-200 active:scale-95">
              Join ZoikoSocial
            </button>
          </div>
        </motion.div>
