...
const ecosystemItems = [
  {
    ...
    description:
      "Native integration with ZoikoTime, ZoikoAssure, ZoikoPay, and ZoikoAxis for comprehensive business intelligence.",
  },
  {
    title: "ERP Connectivity",
    description:
      "Seamless integration with SAP, Oracle, NetSuite, and other enterprise systems through secure APIs and data synchronization.",
  },
  {
    title: "Financial Systems",
    description:
      "Direct connectivity with banks, payment processors, and accounting platforms for real-time financial data and reconciliation.",
  },
  {
    title: "Third-Party Applications",
    description:
      "Extensive marketplace of pre-built integrations and custom API development for unique business requirements.",
  },
];
      ...
      <div className="max-w-6xl mx-auto flex flex-col items-center">
        ...
        <div className="text-center mb-14 md:mb-16 max-w-3xl">
          ...
          <p className="text-[#64748b] text-[14.5px] sm:text-[15.5px] font-normal leading-relaxed">
            Seamless connectivity with existing business systems and Zoiko
            platform
          </p>
        </div>
